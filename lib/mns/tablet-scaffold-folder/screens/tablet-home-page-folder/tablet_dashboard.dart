...
import '../../../mobile-scaffold-folder/screens/offer-folder/offerAndProductInfoWithDropdown.dart';
import '../../../mobile-scaffold-folder/screens/product-folder/product_list.dart';
import '../../../mobile-scaffold-folder/screens/scope-folder/addScopeWithDropdown.dart';
import '../../widgets/bottom_app_bar_widget/tablet_bottom_app_bar.dart';
import '../../widgets/table-expanded-widget/expanded_button_widget.dart';
import '../../widgets/table-expanded-widget/tablet_action_button.dart';


class TabletDashboardScreen extends StatefulWidget {
  List offer;
  List prod;
  TabletDashboardScreen({Key? key, required this.offer, required this.prod})
      : super(key: key);
...
class _TabletDashboardScreenState extends State<TabletDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        floatingActionButton: TabletExpandableFab2(
          distance: 120,
          children: [
            Column(
              children: [
        ...
        bottomNavigationBar: TabletBottomAppBarWidget());
  }
